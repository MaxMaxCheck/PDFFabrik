...
export const metadata = {
  title: "Impressum",
  description: "Impressum und Anbieterkennzeichnung gemäß § 5 TMG — PDFFabrik.de",
}
...
export default function ImpressumPage() {
  return (
    <LegalPageCard title="Impressum" description="Angaben gemäß § 5 TMG">
      ...
      <LegalSection title="Combisystem Vertriebspartner">
        <Link
          href="https://combisystem.de"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="CombiSystems Logo"
          className="inline-block pt-3 text-foreground transition-opacity hover:opacity-80"
        >
          <CombisystemLogo className="h-10 w-auto" />
        </Link>
        <p className="mt-3">Combisystem GmbH</p>
      </LegalSection>
